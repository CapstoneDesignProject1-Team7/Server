...
public interface UserDataMapper {
	...
	int insertUserData(@Param("id") String id, @Param("latitude") double latitude, @Param("longitude") double longitude, @Param("type") boolean type);
	
	@Update("UPDATE UserData SET latitude=${latitude}, longitude=${longitude}, type=${type}")
	int updateUserData(@Param("id") String id, @Param("latitude") double latitude, @Param("longitude") double longitude, @Param("type") boolean type);
